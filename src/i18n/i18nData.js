...
export default {
  en: {
    ...
    Recharge:'Recharge',
    DataList: 'Data List',
    ConnectPayment: 'Connect Payment',
    ...
    ReInputPassword: 'Re-input Password',
    Cancel: 'Cancel',
    Save: 'Save',
    Avatar: 'Avatar',
    ...
    Price: 'Price',
    Acreage: 'Acreage',
    WidthRoad: 'Width of Road',
    Facade: 'Facade',
    Direction: 'Direction',
    UserType: 'User Type',
    PrimaryAccount: 'Primary Account',
    PromotionAccount1: 'Promotion Account 1',
    PromotionAccount2: 'Promotion Account 1',
    BalanceInformation: 'Balance Information',
    TotalBalance: 'Total Balance',
    AvalibleBalance: 'Avalible Balance',
    FreezeBalance: 'Freeze Balance',
    BalanceUnit: 'Unit: VND',
    ...
    Amount: 'Amount (VNĐ)',
    Status: 'Status',
    CardInfomation: 'Card Infomation',
    CreateDate: 'Create Date',
    Action: 'Action',
    SetDefault: 'Set Default',
    Delete: 'Delete',
    AddNewBankAccount: 'Add Bank Account',
    AccountNumber: 'Account Number',
    AccountOwner: 'Account Owner',
    BankName: 'Bank Name',
    ProviceName: 'Provice Name',
  ...
  vi: {
    ...
    DataList: 'Lịch sử giao dịch',
    Video3D: 'Video quay 3D',
    Calendar: 'Lịch up tin',
    Recharge: 'Nạp tiền',
    WaitingforPayment:'Chờ thanh toán',
    ConnectPayment: 'Liên kết thẻ',
    UserManager: 'Quản lý người dùng',
    TransactionHistory: 'Lịch sử giao dịch',
    UserChangePassword: 'Đổi mật khẩu',
    UserInfo: 'Thông tin tài khoản',
    UserFavorite: 'Yêu thích',
    ItemDetails: 'Detalhes do item',
    Cart: 'Carrinho',
    WishList: 'Lista de Desejos',
    Checkout: 'Confira',
    ...
    Gender: 'Giới tính',
    Birthday: 'Ngày sinh',
    DetailInfos: 'Thông tin chi tiết',
    FullName: 'Họ và tên',
    ...
    Price: 'Tổng giá',
    Acreage: 'Diện tích',
    WidthRoad: 'Đường rộng',
    Facade: 'Mặt tiền',
    Direction: 'Hướng',
    UserType: 'Đối tượng',
    PrimaryAccount: 'Tài khoản chính',
    PromotionAccount1: 'Tài khoản khuyến mãi 1',
    PromotionAccount2: 'Tài khoản khuyến mãi 2',
    BalanceInformation: 'Thông tin số dư',
    TotalBalance: 'Tổng số dư',
    AvalibleBalance: 'Số dư khả dụng',
    FreezeBalance: 'Số dư đóng băng',
    BalanceUnit: 'Đơn vị: VNĐ',
    ...
    Amount: 'Số tiền (VNĐ)',
    Status: 'Trạng thái',
    CardInfomation: 'Thông tin thẻ',
    CreateDate: 'Ngày tạo',
    Action: 'Hành động',
    SetDefault: 'Đặt làm mặc định',
    Delete: 'Xóa',
    AddNewBankAccount: 'Thêm tài khoản',
    AccountNumber: 'Số tài khoản',
    AccountOwner: 'Họ tên chủ tài khoản',
    BankName: 'Ngân hàng',
    ProviceName: 'Tỉnh/Thành phố',
    BrancheName: 'Chi nhánh',
    ConnectWalletMeeyPay: 'Liên kết MeeyPay',
    InputPhoneNumber: 'Nhập số điện thoại',
    MsgGuide1Step1: 'Bạn đang thực hiện liên kết tài khoản MeeyLand với MeeyPay',
    MsgGuide2Step1: 'Nhập số điện thoại để bắt đầu',
    MsgGuide3Step1: '* Số điện thoại bắt đầu bằng số 0, gồm 10 chữ số',
    MsgGuide1Step2: 'Nhập mã xác thực gồm 6 số đã được gửi SMS đến số điện thoại',
    MsgGuide2Step2: 'Thời gian hiệu lực:',
    MsgGuide3Step2: 'Không nhận được mã xác thực?',
    ReSend: 'Gửi lại',
    GoBack: 'Quay lại',
    GoNext: 'Tiếp theo',
    Verification: 'Xác thực',
    Finish: 'Hoàn thành',
    MsgConnectWalletSuccess: 'Đã xác thực và liên kết MeeyPay thành công theo số điện thoại',
    ConnectWalletNow: 'Liên kết ngay',
    ChangePhoneNumber: 'Đổi số điện thoại',
    ValidationNow: 'Xác thực ngay'
  }
