...
<template>
  <div id="waitforpayment-app" class="">
    <div class=" border border-r-0 border-b-0 border-t-0  d-theme-border-grey-light">
      <vx-card ref="filterCard" title="Ngày đăng bài" class="user-list-filters mb-8" actionButtons @refresh="resetColFilters" @remove="resetColFilters">
