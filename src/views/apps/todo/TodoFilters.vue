  ...
  data () {
    return {
      todoFilters: [
        ...
        { filterName: 'Tin chờ duyệt', filter: 'important', icon: 'InfoIcon' },
        { filterName: 'Tin VIP', filter: 'completed', icon: 'CheckIcon' },
        { filterName: 'Tin nháp', filter: 'trashed', icon: 'TrashIcon' },
        { filterName: 'Tin đã hết hạn', filter: 'trasheds', icon: 'PauseIcon' }
      ]
    }
  },
  computed: {
