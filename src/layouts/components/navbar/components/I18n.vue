<template>
  ...
  <vs-dropdown-item @click="updateLocale('pt')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/pt.png" alt="pt" /> &nbsp;Portuguese</vs-dropdown-item>-->
      <vs-dropdown-item @click="updateLocale('vi')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/vi.png" alt="vi" /> &nbsp;Việt Nam</vs-dropdown-item>
...
export default {
  computed: {
    i18n_locale_img () {
      ...
      else if (locale === 'vi') return require('@/assets/images/flags/vi.png')
    ...
    getCurrentLocaleData () {
      const locale = this.$i18n.locale
      if (locale === 'en') return { flag: 'us', lang: 'ENG' }
      else if (locale === 'vi') return { flag: 'vi', lang: 'VIE' }
