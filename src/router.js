  ...
  routes: [
    ...
    // =============================================================================
      ...
      children: [
        ...
        {
          path: '/apps/article',
          redirect: '/apps/article/all',
          name: 'article'
        },
        {
          path: '/apps/article/:filter',
          component: () => import('./views/apps/article/Article.vue'),
          meta: {
            rule: 'editor',
            parent: 'article',
            no_scroll: true,
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Quản lý tin đăng', active: true }
            ]
          }
        },
        {
          path: '/apps/article/article-detail/:articleId',
          name: 'article-detail',
          component: () => import('@/views/apps/article/ArticleDetail.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Tin đăng', url: '/apps/article' },
              { title: 'Chi tiết tin đăng', active: true }
            ],
            pageTitle: 'Chi tiết tin đăng',
            rule: 'editor'
          }
        },
        {
          path: '/transactions/connectwallet',
          ...
          meta: {
            ...
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Liên kết MeeyPay', active: true }
            ]
          }
        },
        {
          ...
          component: () => import('./views/transactions/transactionhistory/TransactionHistory.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true,
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Lịch sử giao dịch', active: true }
            ]
          }
        },
        {
          path: '/transactions/waitforpayment',
          name: 'waitforpayment',
          component: () => import('./views/transactions/waitforpayment/WaitForPayment.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true,
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Chờ thanh toán', active: true }
            ]
          }
        },
        {
          path: '/transactions/bankaccounts',
          name: 'transactions-bankaccounts',
          component: () => import('./views/transactions/bankaccounts/BankAccounts.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true,
            breadcrumb: [
              ...
              { title: 'Tài khoản ngân hàng', active: true }
            ]
          }
        },
        {
          path: '/transactions/bankaccounts/add',
          name: 'transactions-bankaccounts-add',
          component: () => import('./views/transactions/bankaccounts/BankAccountInfo.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true,
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Quản lý giao dịch' },
              { title: 'Tài khoản ngân hàng', url:'/transactions/bankaccounts' },
              { title: 'Thêm mới tài khoản ngân hàng', active: true }
            ]
          }
        },
        {
          path: '/transactions/accountbalance',
          name: 'transactions-accountbalance',
          component: () => import('./views/transactions/accountbalance/AccountBalance.vue'),
          meta: {
            rule: 'editor',
            no_scroll: true,
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Quản lý giao dịch' },
              { title: 'Số dư tài khoản', active: true }
            ]
          }
        },
        {
          ...
          meta: {
            ...
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Quản lý dịch vụ', active: true }
            ]
          }
        },
        {
        ...
        // -------------------------------------------------------------------------------------------------------------------------------------------
        {
          ...
          meta: {
            breadcrumb: [
              ...
              { title: 'Thông tin tài khoản', active: true }
            ],
        ...
        },
        {
          path: '/users/favorite',
          name: 'users-favorite',
          component: () => import('@/views/users/UserFavorite.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Quản lý người dùng' },
              { title: 'Yêu thích', active: true }
            ],
            pageTitle: 'Yêu thích',
            rule: 'editor'
          }
